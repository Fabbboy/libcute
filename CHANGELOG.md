...
- fix content-length formatting in http example
...
- add clang-tidy config for naming conventions

<!-- generated by git-cliff -->
- add wasm freestanding build support
- implement minimal sprintf replacements for CU_FREESTANDING
- consolidate nostd headers and unify memory helpers
- rename nostd helpers to follow naming conventions
- rename sprintf helpers to use cu_CString_ prefix
- rewrite nostd implementation to drop stdlib fallbacks
- remove remaining stdio usage and implement custom strtoul
- fix missing includes and newline warnings
