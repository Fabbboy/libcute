...
- add tell functions for streams and files - Codex
...
- replace resize with grow/shrink API
- use realloc in C allocator for in-place grow/shrink - Codex
...
- implement arena allocator grow/shrink with in-place attempts - Codex
